...
const WhatsAppChat: React.FC<WhatsAppChatProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Modal Content */}
      <div
        className="relative w-full max-w-md max-h-[82vh] overflow-hidden rounded-2xl shadow-2xl"
        style={{
      ...
      >
        ...
        >
          ...
          <button
            onClick={onClose}
            className="text-white hover:text-yellow-300 transition-colors p-2 rounded-full hover:bg-gray-800"
        ...
        <div className="p-6 space-y-6 max-h-[60vh] overflow-y-auto">
            ...
            <div className="space-y-3">
              {predefinedMessages.map((msg) => (
                <button
                  ...
                  className={`w-full text-left p-4 rounded-xl border transition-all duration-300 hover:scale-105 transform ${
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full p-4 rounded-xl resize-none transition-all duration-300 focus:ring-2 focus:ring-gold-500 focus:border-transparent"
              rows={3}
              style={{
        ...
        >
          <button
            ...
            className="w-full py-4 px-6 rounded-xl font-bold text-lg transition-all duration-500 hover:scale-105 transform relative overflow-hidden group disabled:opacity-50 disabled:cursor-not-allowed"
            style={{
              background: theme.gradients.gold,
              ...
              marginBottom: "18px", // Add bottom margin to separate from border
            }}
          >
            {/* Button glow effect */}
            <div
